    ...
    try {
        ...
        for (let i = 0; i < values.length; i++) {
            ...
            if (remoteFileSize !== localFileSize) {
                throw new Error(`File upload successful, but sizes don't match - ${localFilePath}`);
            }
            ...
            if (
                ...
                if (hash1 !== hash2) {
                    throw new Error(`File upload successful, but contents don't match - ${localFilePath}`);
                }
            }
        }
