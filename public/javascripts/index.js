...
const createContent = (
  ...
  const html02 = `<div class="content-item ${isIdx ? "active" : ""}">
    <div class="content-item-btns">
      <a href="javascript:" class="nav_a pull-code" title="Pull Code" role="button" data-lan="${lan}"><svg t="1732768966478" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="8422" width="20" height="20"><path d="M550.4 51.2v771.0976l178.816-178.816 54.3232 54.2976L512 969.3184 240.4608 697.7792l54.3232-54.2976 178.7904 178.816L473.6 51.2h76.8z" p-id="8423" fill="#ffffff"></path></svg></a>
      ...
      <a href="javascript:" class="nav_a merge-code" role="button" title="Merge" data-lan="${lan}"><svg t="1732769025139" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="9511" width="20" height="20"><path d="M725.333333 871.04L785.706667 810.666667 640 664.96 579.626667 725.333333 725.333333 871.04zM320 341.333333h149.333333v238.293334L238.293333 810.666667 298.666667 871.04l256-256V341.333333h149.333333l-192-192-192 192z" p-id="9512" fill="#ffffff"></path></svg></a>
